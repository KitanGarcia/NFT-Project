import { initializeKeypair } from "./src/utils/initializeKeypair";
...
import { createNft } from "./src/utils/setup";
import { PROGRAM_ID } from "./src/utils/constants";
import { getStakeAccount } from "./src/utils/accounts";
...
async function testInitializeStakeAccount(
  ...
  console.log("Created stake account 1");

  const transaction = new web3.Transaction();
  transaction.add(createStakeAccount);
  console.log("Added create stake ixn to txn");
